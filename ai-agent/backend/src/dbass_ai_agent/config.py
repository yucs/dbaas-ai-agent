...
class Settings:
    ...
    def from_file(cls, path: Path | None = None) -> "Settings":
        ...
        return cls(
            ...
            dbaas_user_snapshot_refresh_wait_seconds=_get_positive_int(
                dbaas_workspace,
                "user_snapshot_refresh_wait_seconds",
                3,
            ),
            ...
            dbaas_cluster_snapshot_ttl_seconds=_get_positive_int(
                dbaas_workspace,
                "cluster_snapshot_ttl_seconds",
                120,
            ),
