...
class BackupRecord(ApiSchema):
    ...
    siteId: str = Field(description="备份所在站点 ID")
    siteName: str = Field(description="备份所在站点名称")
    service_name: str = Field(description="备份所属服务组名称")
    service_type: str = Field(description="备份所属服务组类型")
    child_service_name: str = Field(description="备份所属子服务名称")
    child_service_type: str = Field(description="备份所属子服务类型，例如 mysql、tidb、tikv")
    unit_name: str = Field(description="备份所属单元名称")
